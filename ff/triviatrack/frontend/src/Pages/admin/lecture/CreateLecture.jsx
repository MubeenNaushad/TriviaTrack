...
const CreateLecture = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post(`${import.meta.env.VITE_APP_BASEURL}/course/${courseId}/lecture`, {
        lectureTitle,
        courseId,
      })
      .then((response) => console.log("Course updated Sucessfully"))
  ...
  useEffect(() => {
    axios
      .get(
        `${import.meta.env.VITE_APP_BASEURL}/course/${courseId}/lecture`,
        courseId
      )
      .then((response) => {
      ...
      <div className="flex-1 mx-10 mt-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              onClick={() => navigate(`/list-course/${courseId}`)}
            >
              Back to course
            </Button>
