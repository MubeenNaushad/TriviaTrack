...
export default function Chatbot() {
  ...
  const surveyQuestions = [
    ...
    {
      question:
        "How much time do you typically spend learning on our platform each day?",
      options: [
      ...
      setMessages([
        {
          ...
          role: "assistant",
          content:
            "Hello learner! How can I help with your educational journey today?",
        },
      ]);
    }
  };
  ...
  const handleSendMessage = (e) => {
    ...
    setTimeout(() => {
      ...
      setMessages((prev) => [
        ...prev,
        { id: Date.now(), role: "assistant", content: randomResponse },
      ]);
    }, 1000);
  };
      ...
      if (nextQuestion < surveyQuestions.length) {
        setMessages((prev) => [
          ...prev,
          {
            id: Date.now(),
            role: "assistant",
            content: surveyQuestions[nextQuestion].question,
          },
        ]);
        ...
        setMessages((prev) => [
          ...
          },
          {
            ...
            role: "assistant",
            content:
              "Would you like to chat about any specific learning topics?",
          },
        ]);
        setMode("chat");
      }
